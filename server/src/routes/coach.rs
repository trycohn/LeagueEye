...
- Выдай РОВНО 2 (два) самых важных совета на текущий момент — не больше и не меньше
- Каждый совет — одна строка, без развёрнутых абзацев
- Фокусируйся только на самом важном прямо сейчас
...
- НЕ пиши введение или заключение, только два совета"#.to_string();
    }
...
- Отвечай ТОЛЬКО на русском языке
- Выдай РОВНО 2 (два) самых важных совета на текущий момент — не больше и не меньше
- Каждый совет — одна короткая строка, без пояснений и развёрнутых абзацев
- Фокусируйся только на самом важном прямо сейчас
